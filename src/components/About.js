  ...
  return (
    <section className='hero-about'>
      ...
      <div id='about-section'>
        <h2>About</h2>
        <p>
          I’m a software developer with a background in environmental science
          and education. Having started to code in the pandemic I decided to
        ...
        <p>
          ...
          strength building parameters and lifting heavy, awkward objects.
        </p>
      </div>
    </section>
  );
