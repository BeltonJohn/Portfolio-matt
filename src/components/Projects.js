      ...
      <div className='each-project'>
        ...
        <div className='each-project'>
          ...
          <div className='project-info'>
            ...
            <p>
              ...
              backend functions. Purely Podcast is a website which allows users
              to find, favourite and add new podcasts. I also built some of the
        ...
        <div className='each-project'>
          ...
          <div className='project-info'>
            ...
            <p>
              ...
              colleagues. I specifically built the search bar and filter
              function with JavaScript React, tested the API with Postman and
              completed parts of the styling with SCSS and Bulma.
            </p>
            <div className='project-links'>
              <a
        ...
        <div className='each-project'>
          ...
          <div className='project-info'>
            ...
            <p>
              a 7 day solo project to test the skills I had learned up until
              that point. The remit of the task was to build a grid based game
              using Vanilla JavaScript, HTML and CSS. Links to the project and
              readme can be found below:
            </p>
            <div className='project-links'>
              <a
